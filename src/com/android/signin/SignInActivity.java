...
import com.android.home.HomeActivity;
...
import com.android.universityrecommender_v1.R.string;
...
public class SignInActivity extends Activity {
	...
	private static final String[] DUMMY_CREDENTIALS = new String[] {
			"smbuch@ncsu.edu:shruti", "bar@example.com:world" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		signinHome=(Button)findViewById(R.id.sign_in_home);
		signinHome.setOnClickListener(new Button.OnClickListener() { public void onClick(View v) { signInHome();}});
		...
		findViewById(R.id.sign_in_signIn).setOnClickListener(
